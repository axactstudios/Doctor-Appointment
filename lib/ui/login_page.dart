...
import 'package:doctorAppointment/doctor_module/LoginPages/PhoneLogin.dart';
import 'package:doctorAppointment/doctor_module/OtherPages/SignedIn.dart';
import 'package:doctorAppointment/style/theme.dart' as Theme;
import 'package:doctorAppointment/ui/ForgotPassword.dart';
import 'package:doctorAppointment/utils/bubble_indication_painter.dart';
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.only(top: 75.0, left: 0),
                  child: new Image(
                      width: 191.0,
                      height: 191.0,
                      fit: BoxFit.fill,
                      image: new AssetImage('assets/img/dog.png')),
                ),
                Padding(
